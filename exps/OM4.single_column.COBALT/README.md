...
- The Shear-driven mixing is a type of turbulence that occurs when different layers of fluid move at different velocities — this velocity difference (shear) can destabilize the flow and lead to vertical mixing of properties like heat, salinity, and momentum.
- The background mixing is the weak, persistent vertical mixing of heat, salt, and momentum that occurs throughout the ocean due to internal wave breaking, micro-scale turbulence, or unresolved small-scale processes. It is not caused by specific forcing (like wind or tides), but rather represents a minimum level of turbulent activity always present in the ocean.
- The tidal mixing: is the vertical mixing in the ocean caused by tidal motions. This mixing plays a crucial role in ocean dynamics, especially in shallow areas and near rough topography. Tidal mixing happens when tidal currents interact with the seafloor, stratified water columns or coastal boundaries. These interactions generate turbulence, leading to vertical mixing of water properties like temperature, salinity, and nutrients.
